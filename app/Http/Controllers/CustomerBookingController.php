...
class CustomerBookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($data['payment_method'] == 'online_payment') {
            ...
            $itemDetails = $services->map(function ($service) {
                return [
                    'id' => $service->id,
                    'price' => $service->price,
                    'quantity' => 1,
            ...
            try {
                ...
                return redirect()->back()->with('error', 'Terjadi kesalahan saat memproses pembayaran online. Silakan coba lagi.');
            }
        } else {
    ...
    public function notificationHandler(Request $request)
    {
        ...
        if ($transactionStatus == 'capture' || $transactionStatus == 'settlement') {
            ...
            return redirect()->route('customer.booking.success');
