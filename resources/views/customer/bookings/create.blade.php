...
<div class="container">
    ...
    <form action="{{ route('customer.bookings.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="full_name" id="full_name" value="{{ old('full_name', Auth::user()->name) }}" class="form-control" required readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" name="booking_date" id="booking_date" value="{{ old('booking_date') }}" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="booking_time">Waktu Booking</label>
            <input type="time" name="booking_time" id="booking_time" value="{{ old('booking_time') }}" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group form-check">
            <input type="checkbox" name="agree_privacy_policy" id="agree_privacy_policy" class="form-check-input" {{ old('agree_privacy_policy') ? 'checked' : '' }} required>
            <label for="agree_privacy_policy" class="form-check-label">Saya setuju dengan Kebijakan Privasi</label>
        </div>
        <div class="form-group form-check">
            <input type="checkbox" name="agree_terms_conditions" id="agree_terms_conditions" class="form-check-input" {{ old('agree_terms_conditions') ? 'checked' : '' }} required>
